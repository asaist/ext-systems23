...
CREATE TABLE ro_birth_certificate (
    ...
    PRIMARY KEY (person_id) REFERENCES ro_person(person_id) ON DELETE RESTRICT
    PRIMARY KEY (father_id) REFERENCES ro_person(person_id) ON DELETE RESTRICT
    PRIMARY KEY (mother_id) REFERENCES ro_person(person_id) ON DELETE RESTRICT
);
...
CREATE TABLE ro_marriage_certificate (
    ...
    PRIMARY KEY (husband_id) REFERENCES ro_person(person_id) ON DELETE RESTRICT
    PRIMARY KEY (wife_id) REFERENCES ro_person(person_id) ON DELETE RESTRICT
);
